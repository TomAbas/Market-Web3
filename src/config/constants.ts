...
export const MARKET_RESOURCE_ADDRESS = process.env.NEXT_PUBLIC_MARKET_RESOURCE_ADDRESS!;
...
export const APTOS_NODE_URL_TEST = process.env.NEXT_PUBLIC_APTOS_NODE_URL_TEST!;
export const APTOS_FAUCET_URL_TEST = process.env.NEXT_PUBLIC_APTOS_FAUCET_URL_TEST!;
